...
- What the delegation-verification workflow must include for each delegated-access authority code (the [per-code obligations](patient-delegated-access.html#issuer-verification-obligations) are the starting point).
